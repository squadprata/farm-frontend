            ...
            <div className="border border-gray-400 w-[637px] h-[385px] rounded-[25px] block relative">
              ...
              <div className="w-[262px] h-[94px] absolute ml-[350px] mt-[-286px]">
                ...
                <ul className="mb-10 text-zinc-500 text-xs list-none">
                  ...
                  <li className="mb-2">Configurações de produtos</li>
                  <li className="mb-2">Gerar relatórios</li>
                  <li className="mb-2">Visualizar histórico detalhado</li>
                  <li className="mb-2">Colocar avisos</li>
                  <li className="mb-2">Criação de lista de compras</li>
